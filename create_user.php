<?php session_start();
require_once('include/create_users_handler.php');
if (!is_logged_and_admin()) {
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="include/create_users_handler.php" method="POST">
            <div class="row">
                <div class="col-xl-6">
                            ...
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                        <button class="btn btn-success" name="create_users">Добавить</button>
                                    </div>
                                </div>
                            </div>
                        </div>
