<?php
session_start();
require_once('include/users_handler.php');
if (!is_logged_in()) {
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info"
                                       data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <i class="fal fa-angle-down d-inline-bl$userock ml-1 fs-md"></i>
                                    </a>
                                    <?php
                                    //                                $user['id'] //Получаю id авторизованого пользлователя.
                                    //                                $users['id'] //Получаю id с цикла foreach allusers
                                    ?>
                                    <?php if (is_admin()) { ?>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="edit.php?id=<?php echo $users['id']; ?>">
                                                <i class="fa fa-edit"></i>
                                                Редактировать</a>
                                            <a class="dropdown-item" href="security.php?id=<?php echo $users['id']; ?>">
                                                <i class="fa fa-lock"></i>
                                                Безопасность</a>
                                            <a class="dropdown-item" href="status.php?id=<?php echo $users['id']; ?>">
                                                <i class="fa fa-sun"></i>
                                                Установить статус</a>
                                            <a class="dropdown-item" href="media.php?id=<?php echo $users['id']; ?>">
